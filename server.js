// === Servidor Universal HAG - com Login e Proteção de Rotas ===
// Compatível com Gateway ITG e Render — sem libs extras (só express e cors)
...
app.use((req, res, next) => {
  if (req.path.startsWith("/dados") || req.path.startsWith("/historico")) {
...
app.all(/^\/atualizar(\/.*)?$/, (req, res) => {
  ...
  try {
    ...
    if (typeof body === "string") {
      ...
      catch { console.log("⚠️ Corpo não-JSON:", body.slice(0, 200)); }
    }
...
// === Dados para dashboard/histórico ===
